...
const allBirthdays = inventors.map((birthday) =>
birthday.year)
...
const allFullnames = inventors.map((fullname) =>
...
inventors.sort((a, b) => {
const oldYoung1 = a.passed - a.year;
const oldYoung2 = b.passed - b.year;
return oldYoung2 - oldYoung1
})
console.log(inventors);
